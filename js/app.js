...
function scrWizard(){
  ...
  body+='<div class="body-empty" style="text-align:left;padding:0 2px 8px;font-size:13px">Send each person their link now, or skip and invite later from Admin → Planning Party.</div>';
  var any=false;
